...
# Version: 4.0 | Updated: 2026-06-02 | Scope: Project-wide
...
5. `.sdd/specs/<feature>/PROJECT_AGENTS.md` - feature-local guidance if present
6. `.sdd/specs/<feature>/spec.md`, `plan.md`, `tasks.md` - generated feature artifacts
7. `frontend/DESIGN.md` - binding frontend visual/UX contract when editing frontend
...
Do not switch to TypeScript, CommonJS, Vite, Next.js, another ORM, another database, another payment gateway, or Bearer-token auth unless a human explicitly approves it.
...
| Course Catalog + Content | Member 2 - Nam | Other modules request course price/status through Course contracts |
| Payment + Enrollment + Access | Member 3 - CuongLH | Owns payments, orders, enrollments, my courses, and course access |
| Learning + Quiz + Final Project | Member 4 - Duc | Uses Access contracts and does not read payments to unlock learning |
| Mentor + Admin + Reports | Member 5 - Tien | Reports read cross-module data through approved services/repositories |
